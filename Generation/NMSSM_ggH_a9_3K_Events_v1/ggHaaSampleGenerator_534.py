...
process.RandomNumberGeneratorService.saveFileName =  cms.untracked.string(
        "RandomEngineState_534.log"
        )

# Input source
process.source = cms.Source("EmptySource")
process.source.firstRun = cms.untracked.uint32(534) #I added this because it was in the SignalSampleGenerator.py
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('NMSSM_a9_ggH_534.root'),
