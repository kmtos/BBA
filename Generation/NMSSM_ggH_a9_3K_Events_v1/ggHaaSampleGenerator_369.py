...
process.maxEvents = cms.untracked.PSet(
        input = cms.untracked.int32(2) #Changed from 2141 to 300 since thats what was in SignalSampleGenerator.py
)
...
process.RandomNumberGeneratorService.saveFileName =  cms.untracked.string(
        "RandomEngineState_369.log"
        )

# Input source
process.source = cms.Source("EmptySource")
process.source.firstRun = cms.untracked.uint32(369) #I added this because it was in the SignalSampleGenerator.py
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('NMSSM_a9_ggH_369.root'),
