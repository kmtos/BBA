...
#  	'MSUB(152)=1 !gg-->H/H1(H/H2)',
	'MSUB(121) = 1 !gg-->bbH1'
#	'MSUB(122) = 1 !qqbar-->bbH1'
	'KFPR(121,2) = 5 !produced quark is b'
#	'KFPR(122,2) = 5 !produced quark is b'
...
## 	'PMAS(C35,1)=125.0 !H/H2 mass',
	'PMAS(C25,1)=125.0 !h/H2 mass', #This replaces our current existing higgs: 500 for Wh1 and 125 for bba
	'PMAS(C35,1)=30.0 !H/H1 mass', #This replaces our psuedoscalar higgs due to some pythia problem with the matrix of a: 125 for Wh1 and 30 for BBA
	'PMAS(C45,1)=500.0 !H3 mass',
	'PMAS(C36,1)=500.0 !a mass', #mass of the light pseudoscalar Higgs in the NMSSM: 9 for Wh1 and 500 for BBA
	'PMAS(C46,1)=500.0 !A2 mass',#mass of the CP-odd Higgs in the NMSSM
...
## 	'PARU(173)=0. !H/H2 (H/H1) coupling to leptons', #force H-->aa
	...
	'PARU(176)=4.0 !H/H2 (H/H1) coupling to (h/H1 (h/H2))(h/H1 (h/H2))', # 0 for Wh1 and 4 for BBA
	...
	'PARU(190)=0. !a coupling to H+/- in AA-->a loops',
        ...
        'MDME(342,1)=0 !  e-              e+',                                                              
        'MDME(343,1)=0 !  mu-             mu+',                                                             
        'MDME(344,1)=1 !  tau-            tau+',#0 for Wh1 and 1 for BBA   
        'MDME(345,1)=0 !  tau(apostrophe)-            tau(apostrophe)+',                                                           
        'MDME(346,1)=0 !  g               g',                                                               
        'MDME(347,1)=0 !  gamma           gamma',                                                           
        'MDME(348,1)=0 !  gamma           Z0',                                                              
        'MDME(349,1)=0 !  Z0              Z0',                                                              
        'MDME(350,1)=0 !  W+              W-',                                                              
        'MDME(351,1)=0 !  Z0              h0',                                                              
        'MDME(352,1)=0 !  h0              h0',                                                              
        ...
        'MDME(356,1)=0 !  h0              A0',                                                              
        'MDME(357,1)=1 !  A0              A0',                                                              
        'MDME(358,1)=0 !  ~chi_10         ~chi_10',                                                         
        'MDME(359,1)=0 !  ~chi_20         ~chi_10',                                                         
        'MDME(360,1)=0 !  ~chi_20         ~chi_20',                                                         
        'MDME(361,1)=0 !  ~chi_30         ~chi_10',                                                         
        'MDME(362,1)=0 !  ~chi_30         ~chi_20',                                                         
        'MDME(363,1)=0 !  ~chi_30         ~chi_30',                                                         
        'MDME(364,1)=0 !  ~chi_40         ~chi_10',                                                         
        'MDME(365,1)=0 !  ~chi_40         ~chi_20',                                                         
        'MDME(366,1)=0 !  ~chi_40         ~chi_30',                                                         
        'MDME(367,1)=0 !  ~chi_40         ~chi_40',                                                         
        'MDME(368,1)=0 !  ~chi_1+         ~chi_1-',                                                         
        'MDME(369,1)=0 !  ~chi_1+         ~chi_2-',                                                         
        'MDME(370,1)=0 !  ~chi_2+         ~chi_1-',                                                         
        'MDME(371,1)=0 !  ~chi_2+         ~chi_2-',                                                         
        'MDME(372,1)=0 !  ~d_L            ~d_Lbar',                                                         
        'MDME(373,1)=0 !  ~d_R            ~d_Rbar',                                                         
        'MDME(374,1)=0 !  ~d_L            ~d_Rbar',                                                         
        'MDME(375,1)=0 !  ~d_Lbar         ~d_R',                                                            
        'MDME(376,1)=0 !  ~u_L            ~u_Lbar',                                                         
        'MDME(377,1)=0 !  ~u_R            ~u_Rbar',                                                         
        'MDME(378,1)=0 !  ~u_L            ~u_Rbar',                                                         
        'MDME(379,1)=0 !  ~u_Lbar         ~u_R',                                                            
        'MDME(380,1)=0 !  ~s_L            ~s_Lbar',                                                         
        'MDME(381,1)=0 !  ~s_R            ~s_Rbar',                                                         
        'MDME(382,1)=0 !  ~s_L            ~s_Rbar',                                                         
        'MDME(383,1)=0 !  ~s_Lbar         ~s_R',                                                            
        'MDME(384,1)=0 !  ~c_L            ~c_Lbar',                                                         
        'MDME(385,1)=0 !  ~c_R            ~c_Rbar',                                                         
        'MDME(386,1)=0 !  ~c_L            ~c_Rbar',                                                         
        'MDME(387,1)=0 !  ~c_Lbar         ~c_R',                                                            
        'MDME(388,1)=0 !  ~b_1            ~b_1bar',                                                         
        'MDME(389,1)=0 !  ~b_2            ~b_2bar',                                                         
        'MDME(390,1)=0 !  ~b_1            ~b_2bar',                                                         
        'MDME(391,1)=0 !  ~b_1bar         ~b_2',                                                            
        'MDME(392,1)=0 !  ~t_1            ~t_1bar',                                                         
        'MDME(393,1)=0 !  ~t_2            ~t_2bar',                                                         
        'MDME(394,1)=0 !  ~t_1            ~t_2bar',                                                         
        'MDME(395,1)=0 !  ~t_1bar         ~t_2',                                                            
        'MDME(396,1)=0 !  ~e_L-           ~e_L+',                                                           
        'MDME(397,1)=0 !  ~e_R-           ~e_R+',                                                           
        'MDME(398,1)=0 !  ~e_L-           ~e_R+',                                                           
        'MDME(399,1)=0 !  ~e_L+           ~e_R-',                                                           
        'MDME(400,1)=0 !  ~nu_eL          ~nu_eLbar',                                                       
        'MDME(401,1)=0 !  ~nu_eR          ~nu_eRbar',                                                       
        'MDME(402,1)=0 !  ~nu_eL          ~nu_eRbar',                                                       
        'MDME(403,1)=0 !  ~nu_eLbar       ~nu_eR',                                                          
        'MDME(404,1)=0 !  ~mu_L-          ~mu_L+',                                                          
        'MDME(405,1)=0 !  ~mu_R-          ~mu_R+',                                                          
        'MDME(406,1)=0 !  ~mu_L-          ~mu_R+',                                                          
        'MDME(407,1)=0 !  ~mu_L+          ~mu_R-',                                                          
        'MDME(408,1)=0 !  ~nu_muL         ~nu_muLbar',                                                      
        'MDME(409,1)=0 !  ~nu_muR         ~nu_muRbar',                                                      
        'MDME(410,1)=0 !  ~nu_muL         ~nu_muRbar',                                                      
        'MDME(411,1)=0 !  ~nu_muLbar      ~nu_muR',                                                         
        'MDME(412,1)=0 !  ~tau_1-         ~tau_1+',                                                         
        'MDME(413,1)=0 !  ~tau_2-         ~tau_2+',                                                         
        'MDME(414,1)=0 !  ~tau_1-         ~tau_2+',                                                
        'MDME(415,1)=0 !  ~tau_1+         ~tau_2-',                                                
        'MDME(416,1)=0 !  ~nu_tauLbar     ~nu_tauL',                                                
        'MDME(417,1)=0 !  ~nu_tauRbar     ~nu_tauR',                                                
        'MDME(418,1)=0 !  ~nu_tauRbar     ~nu_tauL',                                                
        'MDME(419,1)=0 !  ~nu_tauR        ~nu_tauLbar',                                                
